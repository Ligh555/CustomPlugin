...
class BaseLayoutBinderWriter(val model: BaseLayoutModel, val libTypes: LibTypes,val rPackagePath :String) {
    companion object {
    ...
    private fun createStaticInflaters(): List<MethodSpec> {
        ...
        val rLayoutFile = CodeBlock.of("$T.$N", ClassName.get(rPackagePath, "R", "layout"),
            model.baseFileName)
